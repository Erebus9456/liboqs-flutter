...
class LiboqsKem {
  ...
  static String decaps(String cipher, String _secret) {
    ...
    final ffi.Pointer<ffi.Uint8> secretKeyDecapsBytes =
        LiboqsFlutter.toBytesPointer(_secret.codeUnits);
    final int resp = _decaps(kem, sharedSecretDecapsBytes,
        cipherTextDecapsBytes, secretKeyDecapsBytes);
